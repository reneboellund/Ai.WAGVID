...
ALLOWED_HOSTS = [
    item
    for item in os.environ.get("WAGVID_ALLOWED_HOSTS", "localhost,127.0.0.1").split(",")
    if item
]
...
MIDDLEWARE = [
    ...
    "wagvid_app.middleware.MaintenanceReadOnlyMiddleware",
...
WAGVID_OBJECT_SIGNING_SECRET = os.environ.get("WAGVID_OBJECT_SIGNING_SECRET", SECRET_KEY)
WAGVID_OBJECT_GRANT_TTL_SECONDS = int(os.environ.get("WAGVID_OBJECT_GRANT_TTL_SECONDS", "300"))
WAGVID_MIN_FREE_BYTES = int(os.environ.get("WAGVID_MIN_FREE_BYTES", str(5 * 1024**3)))
WAGVID_MAX_UPLOAD_BYTES = int(os.environ.get("WAGVID_MAX_UPLOAD_BYTES", str(20 * 1024**3)))
WAGVID_MAX_CHUNK_BYTES = int(os.environ.get("WAGVID_MAX_CHUNK_BYTES", str(8 * 1024**2)))
